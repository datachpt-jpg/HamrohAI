...
const translations = {
  uz: {
    ...
    team: {
      title: "Bizning Jamoa",
      members: [
        { name: "Atadjanov Jasur", role: "Loyiha asoschisi", desc: "4 yildan ortiq AI marketing va product management sohasida tajriba. DATA o'quv markazi sobiq bosh marketologi. 20+ loyihalar muallifi." },
  ...
  ru: {
    ...
    team: {
      title: "Наша команда",
      members: [
        { name: "Атаджанов Жасур", role: "Основатель проекта", desc: "Более 4 лет опыта в AI маркетинге и управлении продуктами. Бывший главный маркетолог учебного центра DATA." },
  ...
  en: {
    ...
    team: {
      title: "Our Team",
      members: [
        { name: "Atadjanov Jasur", role: "Project Founder", desc: "Over 4 years of experience in AI marketing and product management. Former Chief Marketer of DATA training center." },
            ...
            <div className="flex flex-wrap justify-center gap-6">
               {t.team.members.map((member, idx) => (
                  <div key={idx} className="w-full sm:w-[48%] md:w-[30%] lg:w-[18%] text-center group">
                     <div className="w-24 h-24 mx-auto bg-gradient-to-br from-teal-400 to-blue-500 rounded-full mb-4 flex items-center justify-center text-white text-2xl font-bold shadow-lg group-hover:scale-110 transition duration-300">
